...
class GetMeasureGra(object):
    ...
    def get_measure_gra(self, sysID="CMG-0"):
        url = "{}/sysMeasure/{}/measureGrammar".format(self.baseUrl, sysID)
...
if __name__ == '__main__':
    ...
    at = GetMeasureGra(c, h, a)
    s = at.get_measure_gra()
